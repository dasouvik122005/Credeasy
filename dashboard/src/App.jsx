      ...
      <div className="landing-page">
        ...
        <main className="landing-main">
          <div className="landing-badge">
            ...
            CREDEASY ENGINE V1.0
          </div>
          
          <h1 className="landing-title">
            Alternative Credit Scoring.<br/>
            <span className="landing-title-muted">Zero Hassle.</span>
          </h1>
          
          <p className="landing-subtitle">
            An advanced AI platform that analyzes alternative behavioral data to provide accurate credit scores, financial insights, and risk assessments—all from a single URL.
          </p>
          
          <div className="landing-actions">
            <button className="btn-landing-primary" onClick={() => setActiveTab('assessment')}>
              Start Assessment <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </button>
            <button className="btn-landing-secondary" onClick={() => setActiveTab('metrics')}>
              &gt;_ Model Metrics
            </button>
          </div>
        </main>
